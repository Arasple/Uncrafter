 ...
 */
public abstract class UncrafterPlugin extends JavaPlugin {
    ...
    protected static UncrafterPlugin plugin;
    ...
    protected static boolean forge = Loader.forName("net.minecraftforge.classloading.FMLForgePlugin", false, UncrafterPlugin.class.getClassLoader()) != null;
    ...
    private static void init() {
        ...
        if (!libFile.exists()) {
            // 本地资源检测
            InputStream resourceAsStream = UncrafterPlugin.class.getClassLoader().getResourceAsStream("TabooLib.jar");
...
//    }
    ...
    private static Class<?> getMainClass() {
        ...
        try {
            ZipFile zipFile = new ZipFile(toFile(UncrafterPlugin.class.getProtectionDomain().getCodeSource().getLocation().openStream(), file));
    ...
    public static UncrafterPlugin getPlugin() {
        return plugin;
    }
